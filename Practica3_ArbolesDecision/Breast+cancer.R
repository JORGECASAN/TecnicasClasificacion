...
# Vemos la distribucion de ambas muestras y comprobamos que estén balanceadas
...
arbol.podado <- prune(arbol, cp=.0125)
...
#?prp para ver las distintas opciones de la representación gráfica del arbol
#type=2 explicita la etiquetas de división debajo de cada nodo
